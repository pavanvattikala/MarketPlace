...
@section('content')
	<div class="jumbotron">
      <div class="container">
        ...
        <p>A place where you can sell and buy products in your area</p>
		<p>Go! Ahead and Register</p>
      </div>
    </div>
	<div class="container">
		...
		<form action="/register" method="POST">
			...
			<div class="form-group">
        		...
        		<input type="city" id="city_id" class="form-control" placeholder="start typing City" name="city_id" autocomplete="off" required>
			</div>
			<div class="form-group">
